# Automation script which accept directory name and delete all duplicate files from that directory.
...
def main():
	...
	if (argv[1] == "-h") or (argv[1] == "-H") :
		print("This script is used create log file of duplicate files and delete duplicate files");
		exit();

	if (argv[1] == "-u") or (argv[1] == "-U") :
		print("How to run : python file_name path");
		print("File name : Name of file i.e. directory_watcher here");
		print("path : Path of directory");
		print("Example : python directory_watcher Data");
		exit();
	...
	try :
		...
		print("\nTime taken by this Script is :" , end-start);
